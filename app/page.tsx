    ...
    <div style={styles.wrapper}>
      ...
      <header style={styles.navbar}>
        <div style={styles.navContainer}>
          ...
          <nav style={styles.navLinks}>
            ...
            <a href="#stack" style={styles.navLink}>
              Tech Stack
            </a>
            <a
            ...
            <a
              href="https://github.com/tubeguruji"
              target="_blank"
              rel="noopener noreferrer"
              style={styles.navLink}
            >
      ...
      <section style={styles.heroSection}>
        ...
        <p style={styles.heroSubtitle}>
          The ultimate boilerplate configured with type-safe databases, modular
          auth, payment gateways, background cron schedulers, and modern UI
          libraries. Stop configuring — start shipping.
        </p>

        {/* CTA Buttons */}
        <div style={styles.ctaGroup}>
          <Link href="/sign-up" style={styles.primaryCta}>
            <span>🚀 Get Started huhu</span>
          </Link>
        ...
        <div style={styles.terminalBox}>
          ...
          <div style={styles.terminalContent}>
            ...
            <span style={styles.terminalCommand}>
              npx create-fastnextjs-app@latest
            </span>
          </div>
        </div>
      ...
      <section id="features" style={styles.featuresSection}>
        <div style={styles.sectionHeader}>
          ...
          <p style={styles.sectionSubtitle}>
            Engineered with best practices, seamless developer experience, and
            clean modular code.
          </p>
        </div>
        ...
        <div style={styles.featuresGrid}>
          ...
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureDescription}>
              Pre-configured NextAuth, Clerk, or Better Auth with light-theme
              SignIn/SignUp pages and Proxy edge route restriction.
            </p>
          ...
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureDescription}>
              PostgreSQL, Neon Serverless Postgres, or Supabase powered by
              Drizzle ORM with schema push and studio migration scripts.
            </p>
          ...
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureDescription}>
              Stripe and Lemon Squeezy pre-wired checkout handlers, customer
              portal links, and secure webhook event verification.
            </p>
          ...
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureDescription}>
              Inngest background workers and cron schedules to handle AI tasks,
              notifications, and heavy jobs outside request lifecycles.
            </p>
          ...
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureDescription}>
              Resend and SendGrid API clients with clean endpoint wrappers for
              welcome emails, magic links, and billing alerts.
            </p>
          ...
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureDescription}>
              Tailwind CSS v4, Shadcn UI components, DaisyUI, or FlyonUI with
              responsive dark and light modes out of the box.
            </p>
          ...
          <div style={styles.stepsGrid}>
            <div style={styles.stepItem}>
              ...
              <p style={styles.stepText}>
                Run the CLI and select your database, auth, UI library, and
                payment gateway.
              </p>
            </div>
            <div style={styles.stepItem}>
              ...
              <p style={styles.stepText}>
                Fill in your API credentials in the pre-generated{" "}
                <code>.env</code> file.
              </p>
            </div>
            <div style={styles.stepItem}>
              ...
              <p style={styles.stepText}>
                Deploy seamlessly to Vercel, Railway, or AWS with standard
      ...
      <section style={styles.ctaBannerSection}>
        <div style={styles.ctaBanner}>
          ...
          <p style={styles.ctaBannerText}>
            Join thousands of developers launching faster with the FastNextJS
            boilerplate.
          </p>
